...
public class LdpcNewNew {

    public ArrayList<FEC_Frame> doldpc(ArrayList<FEC_Frame> frames) {
        int framecount = frames.size();
        boolean information[]= new boolean[32400];
        boolean output[]= new boolean[64800];
        boolean parity[]= new boolean[32400];
        ArrayList<FEC_Frame> ldpcencodedframes = new ArrayList<FEC_Frame>();
...
/*        
      ...
      /* for(int i=0; i<32400; i++){
       ...
       for (int j = 0; j < framecount; j++) {
    	   FEC_Frame currentframe = frames.get(j);
