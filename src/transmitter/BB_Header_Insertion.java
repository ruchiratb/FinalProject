...
public class BB_Header_Insertion {
	...
	private static int header_length = fec.BBHeaderLength;
		
	public static ArrayList<FEC_Frame> insertHeader(ArrayList<FEC_Frame> frames) {
		FEC_Frame tempFrame;
		boolean[] header_data;
		for (int i = 0; i < frames.size(); i++) {
			tempFrame = frames.get(i);
			header_data = tempFrame.FEC_frame;
